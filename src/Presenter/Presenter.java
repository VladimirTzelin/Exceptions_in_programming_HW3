...
public class Presenter<V extends View> {
    ...
    public void start() {
        ...
        do {
            ...
            "Введите через пробел: [Фамилию, Имя, Отчество], Дату рождения (дд.мм.гггг), " +
            "Номер телефона (x*10), Пол (f или m)\n"+
            "Например: Иванова Ольга Ивановна 23.01.1970 5647389503 f\n" +
            ...
            if (input.toLowerCase().equals("q")) {
                ...
                if (inputDataCount == -1) {
                    view.printOutput("Введены не все данные!\n");
                } else if (inputDataCount == 0) {
                    view.printOutput("Введены лишние данные!\n");
                } else {
                    try {
    ...
    // Возврат кода ошибки при не соответствии введённых полей
    ...
    //Создаём новую запись полученных данных по фамилии 
